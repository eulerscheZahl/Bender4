...
public class Agent1 {
    public static void main(String[] args) {
        ...
        System.out.println("DRRDDRRRRRRUULLLLUUUUULULLLLLUURRUULLUUUUUURRLLDDDDDDRRDDRRDDRRDDDDDDRRRRDDLLLLLLLLUUUUUULLLLLLUULLUUUULLURDRDDDDRRDDRRRRRRDDDDRRDDRRRRRRUUUUUUUULLUUUUUULLUU");
